...
ui <- fluidPage(theme = bs_theme(version = 4, bootswatch = "minty"),
                navbarPage("agxplorR: Agricultural Trends & Impacts in the US",
                           ...
                           tabPanel("Overview",
                                    ...
                                    h3("Citations"),
                                    br(),
                                    p("Clark, M. A., Springmann, M., Hill, J., & Tilman, D. (2019). Multiple health and environmental impacts of foods. 116(46), 23357–23362."),
                                    br(),
                                    p("Niklas. (2020, August 6). How Much Does an Egg Weigh? (Complete Chart of Various Sizes). Weight of Stuff. https://weightofstuff.com/how-much-does-an-egg-weigh/"),
                                    br(),
                                    p("Poore, J., & Nemecek, T. (2018). Reducing food’s environmental impacts through producers and consumers. 360, 987–992."),
                                    br(),
                                    p("USDA, NASS, BEEF, SLAUGHTER - PRODUCTION, MEASURED IN LB, (2019); https://quickstats.nass.usda.gov/"),
                                    br(),
                                    p("USDA, NASS, CHICKENS, BROILERS - PRODUCTION, MEASURED IN LB, (2019); https://quickstats.nass.usda.gov/"),
                                    br(),
                                    p("USDA, NASS, EGGS - PRODUCTION, MEASURED IN EGGS, (2020); https://quickstats.nass.usda.gov/"),
                                    br(),
                                    p("USDA, NASS, MILK - PRODUCTION, MEASURED IN LB, (1970-2020); https://quickstats.nass.usda.gov/"),
                                    br(),
                                    p("USDA, NASS, TREE NUT TOTALS, UTILIZED - PRODUCTION, MEASURED IN TONS, (2019); https://quickstats.nass.usda.gov/"),
                                    br(),
                                    p("USDA, NASS, PEAS, DRY EDIBLE - PRODUCTION, MEASURED IN CWT, (2020); https://quickstats.nass.usda.gov/"),
                                    br(),
                                    p("USDA, NASS, HOGS - PRODUCTION, MEASURED IN LB, (2019); https://quickstats.nass.usda.gov/"),
                                    br(),
                                    p("USDA, NASS, POTATOES - PRODUCTION, MEASURED IN CWT, (2020); https://quickstats.nass.usda.gov/"),
                                    br(),
                                    p("USDA, NASS, RICE - PRODUCTION, MEASURED IN CWT, (2020); https://quickstats.nass.usda.gov/"),
                                    br(),
                                    br()),
